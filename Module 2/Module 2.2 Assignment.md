...
3. In the editor for `Module 2.2 Assignment`, add your name on the first line above the title, then click “Commit changes”
4. On the `Git-and-GitHub` repository you cloned to your computer in the last assignment, fetch and merge the changes you’ve made in this file into your `main` branch using the command line
